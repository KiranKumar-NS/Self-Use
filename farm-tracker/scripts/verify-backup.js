...
const SHEETS = {
  ...
  'Inventory Events': {
    ...
    fields: {
      ...
      'Death Cause': ['deathCause', 'str'],
      'Linked Animal IDs': ['linkedAnimalIds', 'listSemi'],
      'Linked Transaction ID': ['linkedTransactionId', 'str'],
      'Created By': ['createdBy', 'str'], 'Created By Name': ['createdByName', 'str'],
      'Created At': ['createdAt', 'dateISO'],
    },
  },
  'Animals': {
    ...
    fields: {
      ...
      'Purchase Txn ID': ['purchaseTransactionId', 'str'],
      ...
      'Sale Event ID': ['saleInventoryEventId', 'str'],
      'Death Event ID': ['deathInventoryEventId', 'str'], 'Death Cause': ['deathCause', 'str'],
