          ...
          <div class="section-content">
            ...
            <div class="prereq-box">
              ...
              <ol class="prereq-list">
                ...
                <li><strong>Animals / Crops</strong> — register your stock</li>
  ...
  sections: GuideSection[] = [
    {
      ...
      example: {
        ...
        steps: [
          ...
          'Summary cards show: Income <strong>₹85,000</strong> | Expense <strong>₹42,000</strong> | Profit <strong>₹43,000</strong>',
    ...
    },
    {
      ...
      title: 'Stock (Animals)',
      route: '/stock',
      overview: 'Track every animal from purchase/birth through health management to sale/death. Individual tracking for valuable animals (goats), batch tracking for poultry.',
      prerequisites: [
        ...
        '<strong>Buyers</strong> (optional) — add buyers before recording sales so you can link them. <em>Benefit:</em> auto-tracks buyer purchase history and average rate per animal',
      ],
      steps: [
        { action: 'Add animal', detail: 'Choose Individual (tag ID, breed, gender) or Batch (label, count). Record purchase price or mark as farm-born' },
        { action: 'Track health', detail: 'On animal detail page: add vaccinations (with next-due date), medical records, and weight logs' },
        { action: 'Record sale', detail: 'Click "Record Sale" → select buyer → enter price → system auto-creates income transaction and calculates profit' },
        { action: 'Record death', detail: 'Click "Record Death" → enter cause → appears in mortality dashboard' },
        { action: 'View analytics', detail: 'Stock → Analytics tab shows ROI per animal, breed performance, cost comparison' },
        { action: 'View mortality', detail: 'Stock → Mortality tab shows death rate, causes, financial loss estimates' },
      ],
      example: {
        title: 'Complete Goat Lifecycle',
        scenario: 'You buy a goat, maintain its health, and sell it 4 months later.',
        steps: [
          '<strong>Stock → Add Animal</strong> → Individual | Tag: <strong>G-042</strong> | Breed: <strong>Sirohi</strong> | Gender: <strong>Male</strong>',
          'Origin: <strong>Purchased</strong> | Date: <strong>Jan 15</strong> | Price: <strong>₹5,000</strong>',
          'Jan 20: <strong>Add Vaccination</strong> → PPR vaccine, ₹200 cost, next due: Jul 20',
          'Feb 10: <strong>Add Medical</strong> → Deworming treatment, ₹150 cost',
          'Monthly: <strong>Log Weight</strong> → 12kg → 15kg → 18kg → 22kg (growth chart shows trend)',
          'Feed expenses linked: ₹500 + ₹500 + ₹500 + ₹500 = <strong>₹2,000</strong>',
          'May 15: <strong>Record Sale</strong> → Buyer: Ahmed | Price: <strong>₹12,000</strong>',
          'System shows: Invested = 5,000 + 200 + 150 + 2,000 = <strong>₹7,350</strong> | Profit = <strong>₹4,650 (63%)</strong>',
        ],
      },
      consequences: [
        { skip: 'Don\'t enter purchase price', result: 'Profit calculation is wrong — system thinks the animal was free, so profit = entire sale price (misleading)' },
        ...
        { skip: 'Don\'t log weight', result: 'No growth chart — you can\'t spot underperforming animals or identify which feed works best' },
      ...
      tips: [
        'Use Individual mode for goats/cattle (high value) and Batch mode for chickens (volume)',
    ...
    },
    {
      ...
      route: '/loans',
      overview: 'Track money you owe and money others owe you. Simple mode for personal IOUs, formal mode for bank/gold loans with EMI schedules.',
      prerequisites: [
      ...
      steps: [
        ...
        { action: 'Add formal loan', detail: 'Full details: bank/gold/finance source, interest rate, tenure, EMI calculation' },
      ...
      example: {
        ...
        steps: [
          ...
          'Amount: <strong>₹2,00,000</strong> | Interest: <strong>12% annual</strong> | Tenure: <strong>24 months</strong>',
    ...
    },
    {
      ...
      title: 'Crops',
      route: '/crops',
      overview: 'Log all crop maintenance activities — irrigation, fertilizer, pruning, spraying, and more. Track labor, materials, weather, and costs.',
      prerequisites: [
      ...
      steps: [
        ...
        { action: 'Link costs', detail: 'Attach expense transaction for the activity cost' },
      ],
      example: {
        ...
        steps: [
          ...
          'Cost: <strong>₹1,800</strong> → creates linked expense transaction',
        ],
      },
      consequences: [
        ...
        { skip: 'Don\'t link costs', result: 'Activity logged but not in financial records — dashboard won\'t show true crop expenses' },
      ],
      tips: [
    ...
    },
    {
      ...
      steps: [
        ...
        { action: 'Log wastage', detail: 'Record spoiled quantity with reason' },
